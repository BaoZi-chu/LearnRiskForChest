...
import time
import pandas as pd
from data_process import rules_process as rp
...
class DataInfo(object):
    ...
    def update_ground_truth_info(self, id_2_pair_info):
        ...
        np.save('./results/CAR/' + self.data_name + '_true_label.npy', self.true_labels)
    ...
    def update_activate_matrix(self, effective_rule_idx, rules):
        ...
        np.save('./results/CAR/' + self.data_name + ' rule_activate.npy' , self.rule_activation_matrix)
