...
def get_one_risk_info(
    ...
    pd.DataFrame(all_info).to_csv(
        "/home/ssd0/lfy/result_archive/risk_elem/{}/DBLP-Scholar/pair_info_more.csv".format(data_dir),
        header=None,
        index=None,
    )
    ...
    for data_set in ["train"]:
        ...
        pd.DataFrame(temp_csv).to_csv(
            "/home/ssd0/lfy/result_archive/risk_elem/{}/DBLP-Scholar/325/{}.csv".format(
                data_dir, data_set
            ),
            header=None,
            index=None,
