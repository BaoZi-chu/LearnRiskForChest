...
data_dirs = ['chest_hosp']  # dataset dir
data_sets = ['train', 'val', "test"]
cnns = ['r50','CCT'] #'r101', 'r50','d169','CCT'
layers = ['x4', 'xc'] # ['x4', 'xc','maxif','f','mi','pet','ka']

elem_name_str = "{}"
elems = ["distance", 'knn5', 'knn7','xs5','xs3'] # ["distance", 'knn1', 'knn8','xs5','xs3']
csv_dir_str = "/home/ssd0/lfy/result_archive/{}_{}"  # where you save the distribution csv
# csv_dir_str = "/home/ssd0/lfy/result_archive/tvt/{}_{}"  # where you save the distribution csv
k_list = [5,7] # [1, 8]
archive_dir = "/home/ssd0/lfy/result_archive/risk_elem"  # path to save risk feature csv
